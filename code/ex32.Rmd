...
save(smpm, s2crw, scrw, fmpm.rw, f2crw.rw, fcrw.rw, fmpm.crw, f2crw.crw, fcrw.crw, file = "../data/ex32.RData", compress = "xz")
```
...
simdat <- bind_rows(smpm %>% select(id, date, x, y, s=g),
  ...
  mutate(model = factor(rep(c("mpm","2crw","crw"), each = 25*300))) %>%
