...
\usepackage{fontspec}
\setmainfont[Ligatures=TeX, BoldFont={Helvetica Neue-Bold}, ItalicFont={Helvetica Neue-LightItalic}]{helvetica neue light}
%$else$
%\usepackage{lmodern}
%$endif$
...
%  \begin{center}%
  \let \footnote \thanks
    {\fontsize{12}{14}\selectfont\raggedright  \setlength{\parindent}{0pt} {\bf \@title} \par}%
}
%\fi
\makeatother
...
$if(anonymous)$\hfill $else$$for(author)${\bf $author.name$} \hskip 20pt \emph{\small $author.affiliation$}  $sep$ \par $endfor$ $endif$
