...
func_table <- data.frame(
  Function = c("fit_ssm", "route_path", "fit_mpm", "grab", "osar", "map", "sim", "simfit", "sim_filter", "plot.ssm_df", "plot.osar", "plot.mpm_df", "plot.sim"),
