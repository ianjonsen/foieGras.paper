...
\begin{center}
\author{
{\bf Ian D. Jonsen\affmark[1,]\affmark[*], W. James Grecian\affmark[2], Lachlan Phillips\affmark[1], Gemma Carroll\affmark[3], Clive McMahon\affmark[4], Robert G. Harcourt\affmark[1], and Toby A. Patterson\affmark[5]}\\ \vspace{2mm}
...
\affaddr{\affmark[5]CSIRO Ocean and Atmosphere Research, Hobart, TAS, Australia}\\
