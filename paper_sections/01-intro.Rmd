...
We describe the main features of `foieGras` and illustrate its use through a set of applications drawing on Argos and GPS tracking data. Full R code and data for each of the applications is provided in the Supporting Information. Additional details on package functions and usage can be found in the help files and vignettes (\url{https://ianjonsen.github.io/foieGras/index.html}).
