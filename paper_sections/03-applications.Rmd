...
```
We illustrate the main capabilities of `foieGras` through a set of applications that are for demonstration purposes. Complete code and data for reproducing the applications and for gaining a deeper understanding of `foieGras` functions are provided in the Supplementary Information.
