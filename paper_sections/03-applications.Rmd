...
```
We illustrate the main capabilities of `foieGras` with three applications. Complete R code for reproducing the applications and for gaining a deeper understanding of `foieGras` functions are provided in the Supporting Information (Appendices S1 - S4). Data used in the applications are available [on Dryad](http://url.org).
